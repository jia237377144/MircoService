...
/******************TableAttribute*******************/
using CusTableAttribute = TLZ.ExpressionToSql.TableAttribute;
using SysTableAttribute = System.ComponentModel.DataAnnotations.Schema.TableAttribute;
/******************ColumnAttribute*******************/
using CusColumnAttribute = TLZ.ExpressionToSql.ColumnAttribute;
using SysColumnAttribute = System.ComponentModel.DataAnnotations.Schema.ColumnAttribute;
/******************KeyAttribute*******************/
using CusKeyAttribute = TLZ.ExpressionToSql.KeyAttribute;
