...
namespace EF.Console.Dapper
{
    ...
    static partial class SqlMapper
    {
        ...
        private static void PurgeQueryCacheByType(Type type)
        {
            foreach (KeyValuePair<Identity, CacheInfo> entry in _queryCache)
            {
                CacheInfo cache;
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        {
            CommandDefinition command = new CommandDefinition(sql, (object)param, transaction, commandTimeout, commandType, CommandFlags.Buffered);
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null
        ...
        {
            CommandDefinition command = new CommandDefinition(sql, (object)param, transaction, commandTimeout, commandType, buffered ? CommandFlags.Buffered : CommandFlags.None);
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        private static GridReader QueryMultipleImpl(this IDbConnection cnn, ref CommandDefinition command)
        {
            ...
            try
            {
                ...
                GridReader result = new GridReader(cmd, reader, identity, command.Parameters as DynamicParameters, command.AddToCache);
        ...
        {
            object param = command.Parameters;
            Identity identity = new Identity(command.CommandText, command.CommandType, cnn, effectiveType, param == null ? null : param.GetType(), null);
            CacheInfo info = GetCacheInfo(identity, param, command.AddToCache);
...
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TFourth, TReturn> map, object param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
        ...
        {
            CommandDefinition command = new CommandDefinition(sql, (object)param, transaction, commandTimeout, commandType, buffered ? CommandFlags.Buffered : CommandFlags.None);
            IEnumerable<TReturn> results = MultiMapImpl<TReturn>(cnn, command, types, map, splitOn, null, null, true);
        ...
        static IEnumerable<TReturn> MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(this IDbConnection cnn, CommandDefinition command, Delegate map, string splitOn, IDataReader reader, Identity identity, bool finalize)
        {
            ...
            try
            {
                ...
                {
                    Func<IDataReader, object>[] deserializers = GenerateDeserializers(new Type[] { typeof(TFirst), typeof(TSecond), typeof(TThird), typeof(TFourth), typeof(TFifth), typeof(TSixth), typeof(TSeventh) }, splitOn, reader);
        ...
        sealed partial class DapperRowMetaObject : System.Dynamic.DynamicMetaObject
        {
            ...
            {
                System.Dynamic.DynamicMetaObject callMethod = new System.Dynamic.DynamicMetaObject(
            ...
            {
                Expression[] parameters = new System.Linq.Expressions.Expression[]
                                     {
...
#pragma warning restore 0618
        ...
        internal static Action<IDbCommand, object> CreateParamInfoGenerator(Identity identity, bool checkForDuplicates, bool removeUnused, IList<LiteralToken> literals)
        {
            ...
            DynamicMethod dm = new DynamicMethod(string.Format("ParamInfo{0}", Guid.NewGuid()), null, new[] { typeof(IDbCommand), typeof(object) }, type, true);
...
Type type, IDataReader reader, int startBound = 0, int length = -1, bool returnNullIfFirstMissing = false
...
)
        {
            ...
            DynamicMethod dm = new DynamicMethod(string.Format("Deserialize{0}", Guid.NewGuid()), typeof(object), new[] { typeof(IDataReader) }, true);
            ILGenerator il = dm.GetILGenerator();
            il.DeclareLocal(typeof(int));
...
#pragma warning restore 618
        ...
        public partial class GridReader : IDisposable
        {
            ...
            private IEnumerable<TReturn> MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(Delegate func, string splitOn)
            {
                ...
                try
                {
                    foreach (TReturn r in SqlMapper.MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(null, default(CommandDefinition), func, splitOn, reader, identity, false))
                    {
                        yield return r;
                    }
                }
    ...
    partial class DynamicParameters : SqlMapper.IDynamicParameters, SqlMapper.IParameterLookup, SqlMapper.IParameterCallbacks
    {
        ...
        public void AddDynamicParams(object param)
        {
            ...
            if (obj != null)
            {
                ...
                if (subDynamic == null)
                {
                    IEnumerable<KeyValuePair<string, object>> dictionary = obj as IEnumerable<KeyValuePair<string, object>>;
                    if (dictionary == null)
                    {
...
#pragma warning restore 612, 618
...
#endif
        {
            ...
            DynamicMethod dm = new DynamicMethod(string.Format("ExpressionParam{0}", Guid.NewGuid()), null, new[] { typeof(object), this.GetType() }, true);
            ILGenerator il = dm.GetILGenerator();
            ...
            MethodInfo paramGetter = this.GetType().GetMethod("Get", new Type[] { typeof(string) }).MakeGenericMethod(lastMemberAccess.Type);
    ...
    sealed partial class TableValuedParameter : Dapper.SqlMapper.ICustomQueryParameter
    {
        ...
        {
            PropertyInfo prop = typeof(System.Data.SqlClient.SqlParameter).GetProperty("TypeName", BindingFlags.Instance | BindingFlags.Public);
